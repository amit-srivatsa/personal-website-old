          ...
          <div className="w-full max-w-md relative">
            ...
            <div className="relative bg-white/60 backdrop-blur-xl p-8 rounded-[1.75rem] shadow-2xl ring-1 ring-white/60">
              <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <button
                  type="submit"
                  className="w-full inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white bg-black rounded-2xl hover:bg-gray-800 transition-all duration-200 active:scale-95 shadow-lg shadow-gray-900/20"
                >
                  Subscribe Free
